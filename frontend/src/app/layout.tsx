...
export const metadata: Metadata = {
  ...
  description: "A relaxing yet strategic 8x8 block puzzle game. Place colorful tetromino shapes, clear lines, and chase high scores. No timers, no pressure—just pure puzzle satisfaction. Play free in your browser!",
