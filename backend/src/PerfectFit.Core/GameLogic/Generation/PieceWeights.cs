...
public sealed class PieceWeights
{
    ...
    public enum PieceCategory
    {
        ...
        Large,
        /// <summary>6 cells (Rect2x3, Rect3x2)</summary>
        Heavy,
    ...
    {
        [PieceCategory.Tiny] = 0.1,      // Very rare when safe
        [PieceCategory.Small] = 0.3,
        [PieceCategory.Medium] = 0.6,
        [PieceCategory.Standard] = 1.0,  // Base weight
        [PieceCategory.Large] = 1.2,
        [PieceCategory.Heavy] = 1.0,
        [PieceCategory.Huge] = 0.8       // Common when safe
    };
