...
/// <summary>
/// Represents a 8x8 game board for PerfectFit.
...
public sealed class GameBoard
{
    ...
    /// </summary>
    /// <param name="source">The source array (must be 8x8).</param>
    /// <returns>A new GameBoard instance.</returns>
    /// <exception cref="ArgumentException">If the array is not 8x8.</exception>
