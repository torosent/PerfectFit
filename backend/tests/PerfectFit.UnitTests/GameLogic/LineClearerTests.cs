...
public class LineClearerTests
{
    ...
    public void ClearLines_Should_Not_Clear_Incomplete_Row()
    {
        // Arrange
        var board = new GameBoard();
        // Fill row 0 with 7 cells (missing one)
    ...
    public void ClearLines_Should_Not_Clear_Incomplete_Column()
    {
        // Arrange
        var board = new GameBoard();
        // Fill column 0 with 7 cells (missing one)
    ...
    public void ClearLines_Should_Handle_Full_Board_Clear()
    {
        ...
        // Assert
        result.RowsCleared.Should().HaveCount(8);
        result.ColumnsCleared.Should().HaveCount(8);
        result.TotalLinesCleared.Should().Be(16);
