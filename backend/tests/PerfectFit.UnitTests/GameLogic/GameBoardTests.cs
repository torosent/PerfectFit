...
{
    [Fact]
    public void NewBoard_Should_Be_8x8_And_Empty()
    {
        // Act
        ...
        array.GetLength(0).Should().Be(8);
        array.GetLength(1).Should().Be(8);
    ...
    public void GetValidPositions_Should_Return_All_Valid_Positions()
    {
        ...
        // Assert - empty 8x8 board should have 64 valid positions for 1x1 piece
        positions.Should().HaveCount(64);
    }
    ...
    public void GetValidPositions_Should_Exclude_Invalid_Positions()
    {
        ...
        // Assert - 63 positions (one is occupied)
        positions.Should().HaveCount(63);
    ...
    public void GetValidPositions_Should_Account_For_Piece_Size()
    {
        ...
        // Assert - can place at columns 0-4 (5 positions) for each of 8 rows = 40
        positions.Should().HaveCount(40);
    }
    ...
    public void FromArray_Should_Create_Board_From_Array()
    {
        ...
        board.GetCell(7, 7).Should().BeNull();
    }
